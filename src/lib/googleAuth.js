...
function buildGoogleUrl(appName) {
  ...
  const redirectUri = import.meta.env.VITE_GOOGLE_AUTH_PROXY || import.meta.env.NEXT_PUBLIC_GOOGLE_AUTH_PROXY;
...
export function signInWithGoogle(appName = 'StreamVault') {
